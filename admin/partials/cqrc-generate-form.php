...
<h1>
	<?php
	esc_html_e( 'QR Code Generator', 'custom-qrcode-generator' );
	?>
</h1>
<form method="post" action="" enctype="multipart/form-data" id="wwt-qrcode-generate-form">
	...
	<div class="row" style="display:flex;">
						...
						<div class="select-with-level" style="display: flex; gap: 5px; flex-direction: column;">
							<div style="display: flex; align-items: center;">
								...
								<span id="toggle-password" style="cursor: pointer; margin-left: 5px;" class="site-show-hide-password-ed">
									<input type="checkbox" id="site-show-hide-password"><label for="site-show-hide-password" style="cursor: pointer;"><?php esc_html_e( 'Show Password', 'custom-qrcode-generator' ); ?></label>
								</span>
							</div>
							<span id="password-error-uppercase" style="color: red;">
								<i id="icon-uppercase" class="fas fa-times"></i> <?php esc_html_e( 'At least one uppercase letter.', 'custom-qrcode-generator' ); ?>
							</span>
							<span id="password-error-lowercase" style="color: red;">
								<i id="icon-lowercase" class="fas fa-times"></i> <?php esc_html_e( 'At least one lowercase letter.', 'custom-qrcode-generator' ); ?>
							</span>
							<span id="password-error-digit" style="color: red;">
								<i id="icon-digit" class="fas fa-times"></i> <?php esc_html_e( 'At least one digit.', 'custom-qrcode-generator' ); ?>
							</span>
							<span id="password-error-special" style="color: red;">
								<i id="icon-special" class="fas fa-times"></i> <?php esc_html_e( 'At least one special character', 'custom-qrcode-generator' ); ?>
							</span>
							<span><strong><?php esc_html_e( 'You can password protect a QR code to secure the information (Max 10 characters!).', 'custom-qrcode-generator' ); ?></strong></span>
		...
		<div class="col-md-3" style="padding-left: 20px;width: 30%;display: block;position: sticky !important;!i;!;top: 50px !important;!i;!;height: 100%;">
			<h2><?php esc_html_e( 'QR Code Previous', 'custom-qrcode-generator' ); ?></h2>
			<?php if ( !empty( $qrcode ) && ! empty( $qrcode ) ) { ?>
