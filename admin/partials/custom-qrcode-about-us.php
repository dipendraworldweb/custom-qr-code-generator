...
<script type="text/javascript">jQuery(document).ready(function(e){jQuery("#copy-code-icon").on("click",function(){var e=jQuery("#shortcode-code").text(),o=jQuery("<textarea>").val(e).appendTo("body");o.select(),document.execCommand("copy"),o.remove(),jQuery("#copy-message").show().fadeOut(2e3)})});</script>